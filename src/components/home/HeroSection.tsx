        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight text-black mb-6">
              ACHETEZ{" "}
              <span className="text-[#FF6500]">MOINS CHER</span>
              {" "}SUR VOS BOUTIQUES PRÉFÉRÉES.
            </h1>

            {/* Subtitle */}
            <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-xl">
              Votre Personal Shopper pour vos achats en Europe. Je valide vos commandes, réceptionne vos colis à Paris et organise leur réexpédition. <strong className="text-black">Vous payez le prix réel de votre panier, sans frais cachés ni commission.</strong>
            </p>
